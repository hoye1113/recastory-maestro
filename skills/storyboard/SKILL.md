...
| 规则 | 检测 | 修复 |
|------|------|------|
| SL-001 | 模板化开场视觉 | 用视角 Mental Models 重新设计 |
| SL-002 | 结构词堆砌 | 替换为非线性叙事结构 |
| SL-003 | 信息密度无起伏 | 制造视觉节奏变化 |
| SL-004 | 总结式结尾画面 | 用视角启发式设计结尾 |
| SL-005 | 视觉风格单一 | 注入视角的视觉多样性 |
| SL-006 | 显性过渡画面 | 删除，用内容逻辑隐性衔接 |
