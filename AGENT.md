...
| humanizer-zh | `skills/humanizer-zh/SKILL.md` | 去 AI 味，24 类检测规则（按需加载） |
| nuwa-skill | `skills/nuwa-skill/SKILL.md` | 视角工厂，15 个 nuwa-skill 视角（按需加载） |
| web-video-presentation | `skills/web-video-presentation/SKILL.md` | 分镜方法论参考（按需加载） |
| ingest | `skills/ingest/SKILL.md` | 视频/音频下载、提取 |
| transcribe | `skills/transcribe/SKILL.md` | ASR 转写、说话人分离 |
| render | `skills/render/SKILL.md` | 音频合并、录屏、字幕烧录、视频拼接 |
| research | `skills/research/SKILL.md` | 横纵分析、信息源验证 |
| audit | `skills/audit/SKILL.md` | 反模式检测、质量审计 |

## 核心原则

1. **SKILL.md 就是实现** — AI Agent 按自然语言指令执行，不需要 Python/TypeScript
